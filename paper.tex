...
\begin{table}[h!]
 ...
 \begin{tabular}{|l|l|l|l|l|l|}
   ...
   \hline
   \multicolumn{2}{|c|}{\textbf{\makecell{Branch Predictor:}}} & \multicolumn{4}{c|}{\makecell{64KB TAGE-SC-L}}\\
   \hline
   \multicolumn{2}{|c|}{\textbf{\makecell{Prefetcher (L1D/I+L2):}}} & \multicolumn{4}{c|}{\makecell{DCPT}}\\
   \hline
   \hline
 \end{tabular}
...
\subsection{Per-Workload Threshold Selection}
