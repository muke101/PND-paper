...
\begin{figure*}[t]
  ...
  \caption{Base and improved IPC across SPECspeed 2017 for increasing XS Store Set \cite{xiangshan-gem5} sizes on a medium core (ROB=256). IPC gains increase over the small core, but for the baseline MDP size (256 entries), IPC improvement is still 0.5\% smaller.} 
