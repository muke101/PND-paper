...
\begin{itemize}
        ...
        \item[$\bullet$] Preventing these queries can yield an average IPC gain by 0.47\% and on smaller cores, maintain performance on larger cores, and improve average IPC on highly-constrained cores lacking any memory dependence speculation by 3.1\%.
