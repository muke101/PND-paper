...
\begin{table}[h!]
 ...
 \begin{tabular}{|l|l|l|l|l|}
   ...
   \hline
   \textbf{\makecell{XS Store\\Sets}} & \makecell{SSIT:\\LFST:\\Slots:\\Clear:\\} & \makecell{64\\32\\2\\125k} & \makecell{128\\64\\2\\125k} & \makecell{N/A}\\
   \hline
...
Figure \ref{fig:fullssitsweep} shows an extended plot of the results in Figure \ref{fig:ssitsweep}, including the medium core configuration as well as the small core. 
- shows how pg-mpd works on larger cores and how, even though they can usually afford larger predictors by default anyway, we could still allow them to get the same performance with smaller predictors 
