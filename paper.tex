...
This paper proposes a profile-guided hardware-software co-design to detect frequently memory independent loads. Our profiler labels those loads via their opcode to mark them as \emph{predict-no-dependency} (PND) loads. PND loads bypass MDP and are always scheduled as early as possible, eliminating the possibility of false dependencies without introducing additional hardware overhead. Across SPEC CPU 2017 intspeed, this technique achieves a geomean IPC gain of \textcolor{red}{1.4\%} in the smallest simulated core. On larger cores, performance is maintained, while average MDP power usage is reduced by 40\%.
