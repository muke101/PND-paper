...
Loads are then filtered by whether their profiled store distance is within a certain threshold. The premise PG-MDP builts on is that loads with either none or sufficiently long dependent store distances are good candidates to label as PND. This heuristic captures four different types of behaviours:
\begin{itemize}
