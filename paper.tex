...
1. Formally, let $a$ be the address of a load, and let the SQ contain
store addresses $a_1, a_2, \dots, a_n$ ordered from youngest ($a_1$)
to oldest ($a_n$). The \emph{store distance} is defined as the minimum
index $i$ such that $a = a_i$. If no such index exists, the store
distance is $\infty$.
